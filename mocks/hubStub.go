...
// PublishRevert -
func (h *HubStub) PublishRevert(revertBlock data.RevertBlock) error {
	if h.PublishRevertCalled != nil {
		return h.PublishRevertCalled(revertBlock)
	}
...
// PublishFinalized -
func (h *HubStub) PublishFinalized(finalizedBlock data.FinalizedBlock) error {
	if h.PublishFinalizedCalled != nil {
		return h.PublishFinalizedCalled(finalizedBlock)
	}
