...
// ErrPublisherClosed signals that the publisher has been closed
var ErrPublisherClosed = errors.New("publisher closed")

// ErrPublisherFull signals that the publisher's internal queue is full
var ErrPublisherFull = errors.New("publisher queue full")
